# 2026_03_24
# script to create the following plots from convolution benchmarks from ALL radiation experiments:
...
EXPERIMENT_NAME = "2026_03_SC26_ALL_RAD_CONVS"
...
def proton_convs_analysis():
    ...
    sdc_details_df_list = []
    sdc_df_list = []
    for experiment_name in ALL_RAD_CONVS:
        # load data
