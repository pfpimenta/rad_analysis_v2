...
EXPERIMENT_NAME = "2024_05_CHIPIR"


def analysis_2024_05_CHIPIR():
    ...
    if len(conv_logs_df) == 0:
        unique_model_names = logs_df["model_name"].unique()
        print(f"No convolutions found! Only {list(unique_model_names)}")
        return None
